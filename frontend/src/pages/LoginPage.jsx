                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="bg-red-500 text-white py-3 px-8 rounded-lg font-medium hover:bg-red-600 transition-colors text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                      >
                        {isLoading ? (
                          <>
                      ...
                      <button
                        ...
                        className="text-sm sm:text-base text-red-500 hover:text-red-600 font-medium"
                        disabled={isLoading}
                      >
                        Forgot Password?
                      </button>
